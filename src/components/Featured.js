...
const Featured = () => {
    return (
        <div className='flex flex-col-reverse md:flex-row  mx-auto px-6 sm:px-16 py-6 md:py-10 bg-[#F8F7FC] w-full'>
            {/* Left Side */}
            ...
            <div className=' md:w-1/2 md:ml-12'>
                <div className='flex gap-2 mb-3 md:mb-5 text-center items-center py-3h'>
                ...
                <p className='text-gray-600 font-normal text-md text-justify py-3 lg:py-5 leading-tight'>Transmds is the world’s driving worldwide coordinations supplier — we uphold industry and exchange the worldwide trade of merchandi</p>
